...
=Step 2=:  presenting the solution so a computer or human can understand. 
     1. What does it mean by *presenting the problem*?   
        ...
        - The following is a solution to the finding the largest number problem described in text:
         #+BEGIN_SRC 
...
=Step 3=: Computers follow the instructions from the solution presented to carry out solving the problem as demonstrated above. 
